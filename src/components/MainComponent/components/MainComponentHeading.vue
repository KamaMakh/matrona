        ...
        if (articleObj.hasOwnProperty(key)) {
          if (
            ...
            if (this.isNew) {
              ...
              formData.delete("rubric[sendNotification][type]");
              formData.delete("rubric[sendNotification][title]");
              formData.delete("rubric[sendNotification][body]");
              formData.delete("rubric[sendNotification][phones]");
              formData.delete("rubric[sendNotification]");
            }
          }
        }
      }
